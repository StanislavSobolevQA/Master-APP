...
export function CreateRequestTab({ userDistrict }: CreateRequestTabProps) {
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-gray-900">Создать поручение</h2>
        <p className="text-sm text-gray-600 mt-1">Заполните форму для создания нового поручения</p>
      </div>
